    ...
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        ...
        <span className="relative whitespace-nowrap text-red-600">
          ...
          <span className="relative">Home Ownership 🏠</span>
        </span>{' '}
      </h1>
      <p className="mx-auto my-6 max-w-2xl text-lg tracking-tight text-slate-700">
      <b>Buy more with less upfront</b>. We contribute towards your down payment, so you can secure that dream home without the full deposit.
      </p>
    </Container>
  )
}
